...
function TopMenuItem({ item, navExpanded, isActive, onClick }: TopMenuItemProps) {
...
function KnowledgeItem({ page, navExpanded, isActive, onClick }: KnowledgeItemProps) {
	return (
		<button
			type="button"
...
function ResearchItem({ session, navExpanded, isActive, onClick }: ResearchItemProps) {
	return (
		<button
			type="button"
			key={session.id}
...
function SavedReportItem({ report, navExpanded, isActive, onClick }: SavedReportItemProps) {
	return (
		<button
			type="button"
			key={report.id}
...
function KnowledgeSection({ pages, navExpanded, pathname, searchParams, onItemClick }: KnowledgeSectionProps) {
...
function ResearchSection({ sessions, navExpanded, pathname, searchParams, onItemClick }: ResearchSectionProps) {
...
function SavedReportsSection({ reports, navExpanded, pathname, searchParams, onItemClick }: SavedReportsSectionProps) {
...
function SidebarContent() {
	...
	const isTopMenuActive = (itemId: string) =>
		activeMenu === itemId && pathname === navItems.find(n => n.id === itemId)?.path && !searchParams.get("id");
