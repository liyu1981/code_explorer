...
import { createSession, researchSessionsAtom } from "./_jotai/research-store";
        ...
        <div className="max-w-3xl mx-auto space-y-12">
          ...
          <div className="space-y-8">
            ...
            <div className="flex justify-center pt-4">
              <button
                onClick={() => handleNewResearch()}
                className="flex items-center gap-2 px-8 py-3 bg-muted/50 hover:bg-muted text-muted-foreground hover:text-foreground rounded-xl transition-all font-semibold border border-dashed border-border/50"
              >
                <Plus className="h-5 w-5" />
                Research without codebase
              </button>
            </div>
          </div>
        </div>
