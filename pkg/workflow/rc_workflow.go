...
type RCWorkflowRunner struct {
	...
	critiqueFormat *agent.ResponseFormat
...
func RCWithResponseFormat(rf *agent.ResponseFormat) RCWorkflowRunnerOption {
	return func(r *RCWorkflowRunner) {
		r.responseFormat = rf
	}
}

func NewRCWorkflowRunner(llm agent.LLM, toolRegistry *agent.ToolRegistry, opts ...RCWorkflowRunnerOption) *RCWorkflowRunner {
	r := &RCWorkflowRunner{
		llm:            llm,
...
func NewRCWorkflowRunnerWithJSONFormat(llm agent.LLM, toolRegistry *agent.ToolRegistry, opts ...RCWorkflowRunnerOption) (*RCWorkflowRunner, error) {
	critiqueFormat, err := agent.ResponseFormatFromStruct[CritiqueResponse]("critique_result")
	if err != nil {
...
func (r *RCWorkflowRunner) generateDraft(ctx context.Context) (string, []agent.ToolCall, error) {
...
func (r *RCWorkflowRunner) executeTool(ctx context.Context, tc agent.ToolCall) {
...
func (r *RCWorkflowRunner) Messages() []agent.Message {
	return r.messages
}
