...
func ReactWithResponseFormat(rf *agent.ResponseFormat) ReactWorkflowRunnerOption {
	return func(r *ReactWorkflowRunner) {
		r.responseFormat = rf
	}
}

func NewReactWorkflowRunner(llm agent.LLM, toolRegistry *agent.ToolRegistry, opts ...ReactWorkflowRunnerOption) *ReactWorkflowRunner {
...
func (r *ReactWorkflowRunner) validateResponse(response string, toolCalls []agent.ToolCall) error {
...
func (r *ReactWorkflowRunner) enforceResponseFix(response string, toolCalls []agent.ToolCall) {
...
func (r *ReactWorkflowRunner) executeTool(ctx context.Context, tc agent.ToolCall) {
...
func (r *ReactWorkflowRunner) executeToolStream(ctx context.Context, tc agent.ToolCall, stream protocol.IStreamWriter) {
...
func (r *ReactWorkflowRunner) Messages() []agent.Message {
	return r.messages
}
