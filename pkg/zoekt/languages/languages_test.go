...
func TestGetLanguages(t *testing.T) {
	...
	testCases := []struct {
		...
		{path: "mathematica.m", content: mathematicaContent, expectedLanguages: []string{"Wolfram Language"}, compareFirstOnly: true},
		{
			path: "mathematica2.m",
			content: `
...
`,
			expectedLanguages: []string{"Wolfram Language"},
